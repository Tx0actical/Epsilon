...
The project is in **Initial Development**, also indicated by the badges above. Please consider side-effects before running the script in production environments, do so at your own volition. **Do not run this script, except for, testing environments**.
